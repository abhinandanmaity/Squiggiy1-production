...
const Resetpassworduser = () => {
    ...
    const { resetpassworduser } = router.query;
    ...
    const handlesubmit = (e) => {
        ...
        if (newpassword == cpassword && pvalidate ) {
            ...
            const sendform = async () => {
                ...
                try {
                    const resp = await axios.post(`${process.env.NEXT_PUBLIC_DOMEN_NAME}/api/resetpassword-user`, data);
                    ...
                    setTimeout(() => {
                        ...
                        Router.push(`${process.env.NEXT_PUBLIC_DOMEN_NAME}/user/login`)
        ...
        <div className='min-h-screen'>
            ...
            {<><Head>
                ...
                <div className="">
                    ...
                    <img src="/teamwork-thinking-creative.jpg" alt="" className='w-full h-screen bg-cover bg-no-repeat absolute top-32 xxxs:top-28 xs:top-9 left-0 z-0 blur-sm' />
...
export async function getServerSideProps(context) {
    ...
    const cookie = context.query.resetpassworduser
    ...
    if (token) {
        ...
        let user = await User.findOne({ presetToken: token, pexpireToken: { $gt: Date.now() } })
