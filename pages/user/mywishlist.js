                    ...
                    <div className="-mt-16 sm:-mt-48 lg:-mt-32 xl:-mt-40 2xl:container 2xl:mx-auto flex justify-center items-center space-y-4 px-4 md:px-6 2xl:px-0 mb-16">
                        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 justify-items-between gap-x-6 gap-y-5">
                            ...
                            {products && Object.keys(products).map((item) => {
                                ...
                                return (
                                    <div key={products[item].slug} className="flex flex-col justify-center items-start px-2 bg-white cursor-pointer">

                                        <div className="relative">


                                            <AiOutlineDelete onClick={() => { handledeletewishlist(products[item]) }} className="top-2 left-2 absolute  text-gray-900 hover:text-gray-500 flex justify-center items-center bg-white rounded-full text-base" />
